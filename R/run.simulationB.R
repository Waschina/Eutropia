...
#'             # }
#'
#'             pre_mod_list <- lapply(1:n.cores, return(fork_models))
#'             fork_ids <- clusterApply(cl, pre_mod_list, fun = function(x) {
#'               require(EcoAgents)
#'               SYBIL_SETTINGS("SOLVER","cplexAPI")
#'               sybil::SYBIL_SETTINGS("METHOD", "hybbaropt") # Experimental
#'               #tid <<- x
